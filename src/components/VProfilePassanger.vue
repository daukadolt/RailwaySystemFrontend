<template>
    ...
    <div class="content">
        <div v-if="activetab ==='1'" class="tabcontent">
            <table >
              <tr><td class="legend">Full Name:</td><td class="data">505,990 km<sup>2</sup></td><td rowspan="5"><img class="map" src="https://www.pinclipart.com/picdir/middle/157-1578186_user-profile-default-image-png-clipart.png"></td></tr>
              <tr><td class="legend">Email:</td><td class="data">47 million</td></tr>
              <tr><td class="legend">Phone Number:</td><td class="data">Madrid</td></tr>
            </table>
        </div>
